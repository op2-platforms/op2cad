(defun c:lf-1 (/ lyon1 lyoff lylock msg) 
  (setvar "cmdecho" 0)
  (setq lyon1  "*-1,*-2"
        lyoff  "?D-*"
        lylock "None"
...
(defun c:lf-2 (/ lyon1 lyoff lylock msg) 
  (setvar "cmdecho" 0)
  (setq lyon1  "*-1,*-2"
        lyoff  "?D-*"
        lylock "None"
...
(defun c:lf-3 (/ lyon1 lyoff lylock msg) 
  (setvar "cmdecho" 0)
  (setq lyon1  "*-1,*-2"
        lyoff  "?D-*"
        lylock "None"
...
(defun c:lf-4 (/ lyon1 lyoff lylock msg) 
  (setvar "cmdecho" 0)
  (setq lyon1  "*-1,*-2"
        lyoff  "?D-*"
        lylock "None"
...
(defun c:lf-5 (/ lyon1 lyoff lylock msg) 
  (setvar "cmdecho" 0)
  (setq lyon1  "*-1,*-2"
        lyoff  "?D-*"
        lylock "None"
...
(defun c:lf-6 (/ lyon1 lyoff lylock msg) 
  (setvar "cmdecho" 0)
  (setq lyon1  "*-1,*-2"
        lyoff  "?D-*"
        lylock "None"
...
(defun c:lf-7 (/ lyon1 lyoff lylock msg) 
  (setvar "cmdecho" 0)
  (setq lyon1  "*-1,*-2"
        lyoff  "?D-*"
        lylock "None"
...
(defun c:lf-8 (/ lyon1 lyoff lylock msg) 
  (setvar "cmdecho" 0)
  (setq lyon1  "*-1,*-2"
        lyoff  "?D-*"
        lylock "None"
...
(defun c:lf-9 (/ lyon1 lyoff lylock msg) 
  (setvar "cmdecho" 0)
  (setq lyon1  "*-1,*-2"
        lyoff  "?D-*"
        lylock "None"
...
(defun c:lf-2p (/ lyon1 lyoff lylock msg) 
  (setvar "cmdecho" 0)
  (setq lyon1  "*-1,*-2"
        lyoff  "?D-*"
        lylock "None"
...
(defun c:lf-2d (/ lyon1 lyoff lylock msg) 
  (setvar "cmdecho" 0)
  (setq lyon1  "*-1,*-2"
        lyoff  "?D-*"
        lylock "None"
...
(defun c:lf-2c (/ lyon1 lyoff lylock msg) 
  (setvar "cmdecho" 0)
  (setq lyon1  "*-1,*-2"
        lyoff  "?D-*"
        lylock "None"
...
(defun c:lf-2n (/ lyon1 lyoff lylock msg) 
  (setvar "cmdecho" 0)
  (setq lyon1  "*-1,*-2"
        lyoff  "?D-*"
        lylock "None"
...
(defun c:lf-2pn (/ lyon1 lyoff lylock msg) 
  (setvar "cmdecho" 0)
  (setq lyon1  "*-1,*-2"
        lyoff  "?D-*"
        lylock "None"
...
(defun c:lf-2pn-elev (/ lyon1 lyoff lylock msg) 
  (setvar "cmdecho" 0)
...
(defun c:lf-2pn-sect (/ lyon1 lyoff lylock msg) 
  (setvar "cmdecho" 0)
...
(defun c:lf-2pn-detl (/ lyon1 lyoff lylock msg) 
  (setvar "cmdecho" 0)
...
(defun c:lf-2pd (/ lyon1 lyoff lylock msg) 
  (setvar "cmdecho" 0)
  (setq lyon1  "*-1,?D-*-2"
        lyoff  "?D-*-1"
        lylock "None"
...
(defun c:lf-2pd-elev (/ lyon1 lyoff lylock msg) 
  (setvar "cmdecho" 0)
...
(defun c:lf-2pd-sect (/ lyon1 lyoff lylock msg) 
  (setvar "cmdecho" 0)
  (setq lyon1  "*-EXST,*-E,*-XNOT,*-X,*-DEMO,*-D,*-SAVE,*-S,*TEMP,*-T,*-MOVE,*-M"
        lyoff  "*ELEV*,*DETL*"
        lylock "None"
...
(defun c:lf-2pd-detl (/ lyon1 lyoff lylock msg) 
  (setvar "cmdecho" 0)
  (setq lyon1  "*-EXST,*-E,*-XNOT,*-X,*-DEMO,*-D,*-SAVE,*-S,*TEMP,*-T,*-MOVE,*-M"
        lyoff  "*SECT*,*ELEV*"
        lylock "None"
...
(defun c:lf-2pd-sect-lock (/ lyon1 lyoff lylock msg) 
  (setvar "cmdecho" 0)
  (setq lyon1  "*-EXST,*-E,*-XNOT,*-X,*-DEMO,*-D,*-SAVE,*-S,*TEMP,*-T,*-MOVE,*-M"
        lyoff  "None"
        lylock "*ELEV*,*DETL*"
...
(defun c:lf-2pd-detl-lock (/ lyon1 lyoff lylock msg) 
  (setvar "cmdecho" 0)
  (setq lyon1  "*-EXST,*-E,*-XNOT,*-X,*-DEMO,*-D,*-SAVE,*-S,*TEMP,*-T,*-MOVE,*-M"
        lyoff  "None"
        lylock "*SECT*,*ELEV"
