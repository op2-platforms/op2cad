...
(defun op2cad () 
  ...
  ; op2cad tools
  (setq dir_aca-catalogs (strcat dir_op2cadtools "\\aca-catalogs"))
  (setq dir_aca-content (strcat dir_op2cadtools "\\aca-content"))
  (setq dir_aca-details (strcat dir_op2cadtools "\\aca-details"))
  (setq dir_aca-styles (strcat dir_op2cadtools "\\aca-styles"))
  ...
  (setq cur_texmap (vla-get-texturemappath (vla-get-Files preferences)))
  ...
  (setq cur_supplot (vla-get-printerconfigpath (vla-get-Files preferences)))
  (if (/= dir_plot cur_supplot) 
    (progn 
      (vla-put-printerconfigpath (vla-get-Files preferences) dir_plot)
      (prompt (strcat "\n..." dir_plot))
    )
  )
  (setq cur_supplotpmp (vla-get-printerdescpath (vla-get-Files preferences)))
  (if (/= dir_plotpmp cur_supplotpmp) 
    (progn 
  ...
  (if 
    (and (= dir_plot cur_supplot) 
         (= dir_plotpmp cur_supplotpmp)
         (= dir_plotstyle cur_supplotstyle)
    )
    (prompt "\n...OK")
  )
  ...
  (defun c:texturepaths () 
    ...
    (if (= nil (vl-string-search dir_tex11 cur_texmap)) 
      (progn 
        (setq cur_texmap (vla-get-texturemappath (vla-get-Files preferences)))
        (vla-put-texturemappath (vla-get-Files preferences) (strcat cur_texmap ";" dir_tex11))
        (prompt (strcat "\n..." dir_tex11))
      )
    )
    (if (= nil (vl-string-search dir_tex12 cur_texmap)) 
      (progn 
        (setq cur_texmap (vla-get-texturemappath (vla-get-Files preferences)))
        (vla-put-texturemappath (vla-get-Files preferences) (strcat cur_texmap ";" dir_tex12))
        (prompt (strcat "\n..." dir_tex12))
      )
    )
    (if (= nil (vl-string-search dir_tex13 cur_texmap)) 
      (progn 
        (setq cur_texmap (vla-get-texturemappath (vla-get-Files preferences)))
        (vla-put-texturemappath (vla-get-Files preferences) (strcat cur_texmap ";" dir_tex13))
        (prompt (strcat "\n..." dir_tex13))
      )
    )
    (if (= nil (vl-string-search dir_tex14 cur_texmap)) 
      (progn 
        (setq cur_texmap (vla-get-texturemappath (vla-get-Files preferences)))
        (vla-put-texturemappath (vla-get-Files preferences) (strcat cur_texmap ";" dir_tex14))
        (prompt (strcat "\n..." dir_tex14))
      )
    )
    (if (= nil (vl-string-search dir_tex15 cur_texmap)) 
      (progn 
        (setq cur_texmap (vla-get-texturemappath (vla-get-Files preferences)))
        (vla-put-texturemappath (vla-get-Files preferences) (strcat cur_texmap ";" dir_tex15))
        (prompt (strcat "\n..." dir_tex15))
      )
    )
    (if (= nil (vl-string-search dir_tex16 cur_texmap)) 
      (progn 
        (setq cur_texmap (vla-get-texturemappath (vla-get-Files preferences)))
        (vla-put-texturemappath (vla-get-Files preferences) (strcat cur_texmap ";" dir_tex16))
        (prompt (strcat "\n..." dir_tex16))
      )
    )
    (if (= nil (vl-string-search dir_tex17 cur_texmap)) 
      (progn 
        (setq cur_texmap (vla-get-texturemappath (vla-get-Files preferences)))
        (vla-put-texturemappath (vla-get-Files preferences) (strcat cur_texmap ";" dir_tex17))
        (prompt (strcat "\n..." dir_tex17))
      )
    )
    (if (= nil (vl-string-search dir_tex18 cur_texmap)) 
      (progn 
        (setq cur_texmap (vla-get-texturemappath (vla-get-Files preferences)))
        (vla-put-texturemappath (vla-get-Files preferences) (strcat cur_texmap ";" dir_tex18))
        (prompt (strcat "\n..." dir_tex18))
      )
    )
    (if (= nil (vl-string-search dir_tex19 cur_texmap)) 
      (progn 
        (setq cur_texmap (vla-get-texturemappath (vla-get-Files preferences)))
        (vla-put-texturemappath (vla-get-Files preferences) (strcat cur_texmap ";" dir_tex19))
        (prompt (strcat "\n..." dir_tex19))
      )
    )
    (if (= nil (vl-string-search dir_texq1 cur_texmap)) 
      (progn 
        (setq cur_texmap (vla-get-texturemappath (vla-get-Files preferences)))
        (vla-put-texturemappath (vla-get-Files preferences) (strcat cur_texmap ";" dir_texq1))
        (prompt (strcat "\n..." dir_texq1))
      )
    )
    (if (= nil (vl-string-search dir_texq2 cur_texmap)) 
      (progn 
        (setq cur_texmap (vla-get-texturemappath (vla-get-Files preferences)))
        (vla-put-texturemappath (vla-get-Files preferences) (strcat cur_texmap ";" dir_texq2))
        (prompt (strcat "\n..." dir_texq2))
      )
    )
    (if (= nil (vl-string-search dir_texq3 cur_texmap)) 
      (progn 
        (setq cur_texmap (vla-get-texturemappath (vla-get-Files preferences)))
        (vla-put-texturemappath (vla-get-Files preferences) (strcat cur_texmap ";" dir_texq3))
        (prompt (strcat "\n..." dir_texq3))
      )
    )
    (if (= nil (vl-string-search dir_texq4 cur_texmap)) 
      (progn 
        (setq cur_texmap (vla-get-texturemappath (vla-get-Files preferences)))
        (vla-put-texturemappath (vla-get-Files preferences) (strcat cur_texmap ";" dir_texq4))
        (prompt (strcat "\n..." dir_texq4))
      )
    )
    (if (= nil (vl-string-search dir_texq5 cur_texmap)) 
      (progn 
        (setq cur_texmap (vla-get-texturemappath (vla-get-Files preferences)))
        (vla-put-texturemappath (vla-get-Files preferences) (strcat cur_texmap ";" dir_texq5))
        (prompt (strcat "\n..." dir_texq5))
      )
    )
    (if (= nil (vl-string-search dir_texq6 cur_texmap)) 
      (progn 
        (setq cur_texmap (vla-get-texturemappath (vla-get-Files preferences)))
        (vla-put-texturemappath (vla-get-Files preferences) (strcat cur_texmap ";" dir_texq6))
        (prompt (strcat "\n..." dir_texq6))
      )
    )
    (if (= nil (vl-string-search dir_texq7 cur_texmap)) 
      (progn 
        (setq cur_texmap (vla-get-texturemappath (vla-get-Files preferences)))
        (vla-put-texturemappath (vla-get-Files preferences) (strcat cur_texmap ";" dir_texq7))
        (prompt (strcat "\n..." dir_texq7))
      )
    )
    (if (= nil (vl-string-search dir_texq8 cur_texmap)) 
      (progn 
        (setq cur_texmap (vla-get-texturemappath (vla-get-Files preferences)))
        (vla-put-texturemappath (vla-get-Files preferences) (strcat cur_texmap ";" dir_texq8))
        (prompt (strcat "\n..." dir_texq8))
      )
    )
    (if (= nil (vl-string-search dir_texq9 cur_texmap)) 
      (progn 
        (setq cur_texmap (vla-get-texturemappath (vla-get-Files preferences)))
        (vla-put-texturemappath (vla-get-Files preferences) (strcat cur_texmap ";" dir_texq9))
        (prompt (strcat "\n..." dir_texq9))
      )
    )
    (if 
      (and (/= nil (vl-string-search dir_tex11 cur_texmap)) 
           (/= nil (vl-string-search dir_tex12 cur_texmap))
           (/= nil (vl-string-search dir_tex13 cur_texmap))
           (/= nil (vl-string-search dir_tex14 cur_texmap))
           (/= nil (vl-string-search dir_tex15 cur_texmap))
           (/= nil (vl-string-search dir_tex16 cur_texmap))
           (/= nil (vl-string-search dir_tex17 cur_texmap))
           (/= nil (vl-string-search dir_tex18 cur_texmap))
           (/= nil (vl-string-search dir_tex19 cur_texmap))
           (/= nil (vl-string-search dir_texq1 cur_texmap))
           (/= nil (vl-string-search dir_texq2 cur_texmap))
           (/= nil (vl-string-search dir_texq3 cur_texmap))
           (/= nil (vl-string-search dir_texq4 cur_texmap))
           (/= nil (vl-string-search dir_texq5 cur_texmap))
           (/= nil (vl-string-search dir_texq6 cur_texmap))
           (/= nil (vl-string-search dir_texq7 cur_texmap))
           (/= nil (vl-string-search dir_texq8 cur_texmap))
           (/= nil (vl-string-search dir_texq9 cur_texmap))
      )
      (prompt "\n...OK")
    )
  )
